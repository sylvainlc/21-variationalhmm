...
\newcommand{\retrokmod}{\boldsymbol{\mathcal{L}}^{\parvar,\theta}}
...
\newcommand{\vd}[1]{q_{#1}^{\parvar}} % Density
\newcommand{\kvd}[1]{q_{#1}^{\parvar}} % Kernel
\newcommand{\ivd}[1]{\tilde{q}_{#1}^{\parvar}} % Kernel
\newcommand{\jvd}{q} % Joint variational distribution
...
%%%%%%
%% Submission commands
\newcommand{\PG}[1]{\textcolor{blue}{PG: #1}}
