...
$$
and define the normalized measure $\tilde\phi^\parvar_mh$ by $\postmod{m - 1} \uk{m-1, n}{\parvec}h/\postmod{m - 1} \uk{m-1,n}{\parvec}\1$, so that
\begin{align*}
 \frac{\postmod{m} \retrokmod_{m, n} \addf[n]{k}}{\postmod{m} \retrokmod_{m, n} \1_{}} &- \frac{\postmod{m - 1} \retrokmod_{m - 1, n} \addf[n]{k}}{\postmod{m - 1} \retrokmod_{m - 1, n} \1_{}}  \\
...
%\begin{multline*}
%\postmod{0:n} \addf[n]{k} - \post{0:n} \addf[n]{k} = \frac{\postmod{0} \uk{0, n}{\parvec} \addf[n]{k}}{\postmod{0} \uk{0, n}{\parvec} \1_{\Xset^n}} - \frac{\chi \uk{0, n}{\parvec} \addf[n]{k}}{\chi\uk{0, n}{\parvec} \1_{\Xset^n}} + \sum_{m = 1}^k \left( \noshift_{m, n} \retrokmodnorm_{m, n} \addf[n]{k} - \shiftbwd_{m, n}  \retrokmodnorm_{m, n} \addf[n]{k} \right) \\ 
...
%\begin{equation} \label{eq:retro:prospective:id}
%\postmod{0:m} \uk{m, n} h = \postmod{m} \retrokmod_{m, n} h.  
%\end{equation}
%\end{lemma}
...
%\sum_{m = 1}^n \left( \frac{\postmod{0:m} \uk{m, n} \addf[n]{k}}{\postmod{0:m} \uk{m, n} \1_{\Xset^n}} - \frac{\postmod{0:m - 1} \uk{m - 1, n} \addf[n]{k}}{\postmod{0:m - 1} \uk{m - 1, n} \1_{\Xset^n}} \right)  
%\end{equation*}
%
%
%
