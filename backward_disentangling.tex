...
%\end{equation}
\textcolor{red}{Here we follow the proofs of \cite{} using strong mixing for both the original model and the variational family. Should see if this can be relaxed.}
