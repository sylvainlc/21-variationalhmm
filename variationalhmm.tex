...
$$
For all $1\leq t \leq T$, there exists $K_{t-1|t}$ such that for all $\varphi, \varphi'$ and $x,x'$,
$$
\left| q_{\varphi,t-1|t}(x,x') - q_{\varphi',t-1|t}(x,x')\right| \leq  K_{t-1|t}(x',x)\|\varphi-\varphi'\|_2\eqsp.
$$
\end{hypH}
