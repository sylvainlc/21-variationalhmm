...
p^{\star}(y)dxdy
$$
The maximizers of this limit are investigated in \cite{koehler2021variational} in scenarii used in VAE. If we assume that the $q_{\varphi,t}$ indeed depend on $t$, then if we write for each $\theta$,
$$
