...
\subsection{A fully tractacle variational approximation}
...
\subsection{Replacing the Kalman update with a learnt filtering recursion}
\dots

\subsection{Nonlinear observation model}
